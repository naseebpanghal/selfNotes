...
private:
  ...
  {
    //std::cout << "Data sent to client. Going to start async_write again." << "\n";
    start();
    //std::cout << "after start func " << pthread_self() << "\n";
    usleep(1000000);
  }
  ...
  void start_accept()
  {
    ...
    acceptor_.async_accept(new_connection->socket(),
        boost::bind(&tcp_server::handle_accept, this, new_connection,
          boost::asio::placeholders::error));
    std::cout << "async_accept is called" << "\n";
...
int main()
{
  try
  {
    ...
    std::cout << "just before io_server.run" << "\n";
